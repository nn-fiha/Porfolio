  ...
  return (
    <section className="rounded-lg overflow-hidden shadow-lg px-6 py-3 border">
      ...
      <div className="grid grid-cols-2 md:flex gap-16 p-8">
          ...
          <div>        
            <img src={process.env.PUBLIC_URL + '/images/html5.png'} alt="" className='w-20 h-20'/>
          ...
          <div>
          <img src={process.env.PUBLIC_URL + '/images/css.png'} alt="" className='w-20 h-20'/>
          ...
          <div>
          <img src={process.env.PUBLIC_URL + '/images/js.png'} alt="" className='w-20 h-20'/>
          ...
          <div>
          <img src={process.env.PUBLIC_URL + '/images/react.png'} alt="" className='w-20 h-20'/>
          ...
          <div>
          <img src={process.env.PUBLIC_URL + '/images/tailwind.png'} alt="" className='w-20 h-20'/>
          ...
          <div>
          <img src={process.env.PUBLIC_URL + '/images/bootstrap.png'} alt="" className='w-20 h-20'/>
