...
const Tools = () => {
  return (
    <section className=" rounded-lg overflow-hidden shadow-lg px-6 py-3 border">
      ...
      <div className="grid grid-cols-2 md:flex gap-5 md:gap-10 py-5 px-5">
        
          <div className='flex flex-col items-center'>
            <img src={process.env.PUBLIC_URL + '/images/github.png'} alt="" className='w-16 h-16'/>
            <h3 className="text-sm font-medium">Git & GitHub</h3>
            <span className="text-[10px] text-gray-500">Intermediate</span>
          </div>
        
          <div className='flex flex-col items-center'>
            <img src={process.env.PUBLIC_URL + '/images/postman.png'} alt="" className='w-16 h-16'/>
            <h3 className="text-sm font-medium">Postman</h3>
            <span className="text-[10px] text-gray-500">Intermediate</span>
          </div>
          
          <div className='flex flex-col items-center'>
            <img src={process.env.PUBLIC_URL + '/images/vscode.png'} alt="" className='w-16 h-16'/>
          ...
          <div className='flex flex-col items-center'>
            <img src={process.env.PUBLIC_URL + '/images/azure.png'} alt="" className='w-16 h-16'/>
            <h3 className="text-sm font-medium">Azure Devops</h3>
            <span className="text-[10px] text-gray-500">Basic</span>
          </div>
   
          <div className='flex flex-col items-center'>
            <img src={process.env.PUBLIC_URL + '/images/trello.png'} alt="" className='w-16 h-16'/>
            <h3 className="text-sm font-medium">Trello</h3>
            <span className="text-[10px] text-gray-500">Intermediate</span>
          </div>
      
          <div className='flex flex-col items-center'>
            <img src={process.env.PUBLIC_URL + '/images/slack.png'} alt="" className='w-16 h-16'/>
            <h3 className="text-sm font-medium">Slack</h3>
            <span className="text-[10px] text-gray-500">Intermediate</span>
          </div>

          <div className='flex flex-col items-center'>
            <img src={process.env.PUBLIC_URL + '/images/discord.png'} alt="" className='w-16 h-16'/>
