  ...
  return (
    <section className="rounded-lg overflow-hidden shadow-lg px-6 py-3 border">
      ...
      <div className="grid grid-cols-2 md:flex gap-16 p-8">
          <div>
           <img src={process.env.PUBLIC_URL + '/images/nodejs.png'} alt="" className='w-20 h-20'/>
          ...
          <div>
           <img src={process.env.PUBLIC_URL + '/images/express.png'} alt="" className='w-20 h-20'/>
            <h3 className="text-sm font-medium">Express JS</h3>
            <span className="text-[10px] text-gray-500">Intermediate</span>
          </div>
        
          <div>
            <img src={process.env.PUBLIC_URL + '/images/django.png'} alt="" className='w-20 h-20'/>
          ...
          <div>
           <img src={process.env.PUBLIC_URL + '/images/restapi.png'} alt="" className='w-20 h-20'/>
          ...
          <div>
          <img src={process.env.PUBLIC_URL + '/images/mysql.png'} alt="" className='w-20 h-20'/>
          ...
          <div>
          <img src={process.env.PUBLIC_URL + '/images/mongo.png'} alt="" className='w-20 h-20'/>
